...
class AppStyle {
  ...
  static TextStyle textstylerobotoromanmedium181 =
      textstylerobotoromanmedium18.copyWith();
  ...
  static TextStyle textstylerobotoregular14 = TextStyle(
  ...
  static TextStyle textstyleabelregular151 = textstyleabelregular15.copyWith(
  ...
  static TextStyle textstyleabelregular15 = TextStyle(
    color: ColorConstant.black900Null,
    fontSize: getFontSize(
      15,
    ),
  ...
  static TextStyle textstylepoppinsregular19 = TextStyle(
    color: ColorConstant.black900Null,
    fontSize: getFontSize(
      19,
    ),
  ...
  static TextStyle textstylepoppinsregular8 =
      textstylepoppinsregular15.copyWith(
    fontSize: getFontSize(
      8,
    ),
  );
